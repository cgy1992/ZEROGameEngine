...
Matrix4 ZERO::Math::MatrixRotationAxis(const Vector3& axis, float rad)
{
...
Matrix4 ZERO::Math::QuaternionToMatrix(const Quaternion& q)
{
	return Matrix4
	(
...
Quaternion ZERO::Math::Slerp(const Quaternion& q0, const Quaternion& q1, float t)
{
...
//----------------------------------------------------------------------------------------------------
Quaternion ZERO::Math::EulerToQuaternion(float x, float y, float z)
{
	Quaternion q;
	float sx, sy, sz;
	float cx, cy, cz;
...
Math::Vector3 ZERO::Math::QuaternionToEuler(const Quaternion& q1)
{
	Vector3 eulerAngles;
...
Quaternion ZERO::Math::Conjugate(Quaternion q0)
{
	Quaternion q1;
	q1.w = q0.w;
	q1.x = -q0.x;
...
//----------------------------------------------------------------------------------------------------
Quaternion ZERO::Math::Inverse(Quaternion q0)
{
...
//----------------------------------------------------------------------------------------------------
Quaternion ZERO::Math::LookRotation(const Vector3& look, const Vector3& up)
{
...
Quaternion ZERO::Math::FromToQuaternion(const Vector3& from,const Vector3& to)
{
...
//----------------------------------------------------------------------------------------------------
Quaternion ZERO::Math::QuaternionFromAxisAngle(const Vector3& axis, float angleDegrees)
{
	Quaternion q;
...
//----------------------------------------------------------------------------------------------------
Quaternion ZERO::Math::QuaternionFromMatrix(const Matrix4& mat)
{
...
bool ZERO::Math::PointInRect(const Vector2& point, const Rect& rect)
{
...
bool ZERO::Math::PointInCircle(const Vector2& point, const Circle& circle)
{
...
bool ZERO::Math::Intersect(const LineSegment& a, const LineSegment& b)
{
...
bool ZERO::Math::Intersect(const Circle& c0, const Circle& c1)
{
...
bool ZERO::Math::Intersect(const Rect& r0, const Rect& r1)
{
	if (r0.left > r1.right)
		return false;
...
bool ZERO::Math::Intersect(const AABB2D& aabb0, const AABB2D& aabb1)
{
...
bool ZERO::Math::Intersect(const LineSegment& l, const Circle& c)
{
...
bool ZERO::Math::Intersect(const Circle& c, const LineSegment& l)
{
...
bool ZERO::Math::Intersect(const Circle& c, const Rect& r)
{
...
bool ZERO::Math::Intersect(const Rect& r, const Circle& c)
{
	Vector2 closestPoint;
...
bool ZERO::Math::Intersect(const Ray& ray, const Vector3& a, const Vector3& b, const Vector3& c, float& distance)
{
...
bool ZERO::Math::Intersect(const Ray& ray, const Plane& plane, float& distance)
{
...
bool ZERO::Math::Intersect(const Ray& ray, const AABB& aabb, float& distEntry, float& distExit)
{
...
//bool ZERO::Math::Intersect(const Ray& ray, const OBB& obb, float& distEntry, float& distExit)
//{
...
bool ZERO::Math::Intersect(const Vector3& point, const AABB& aabb)
{
...
//bool ZERO::Math::Intersect(const Vector3& point, const OBB& obb)
//{
//	// Compute the local-to-world/world-to-local matrices
//	Matrix4 matTrans = Matrix4::Translation(obb.center.x, obb.center.y, obb.center.z);
//	Matrix4 matRot = MatrixRotationQuaternion(obb.orientation);
...
Rect ZERO::Math::GetAABB2DIntersectionRect(const AABB2D& aabb0, const AABB2D& aabb1)
{
	Rect intersection;
...
//void ZERO::Math::GetCorners(const OBB& obb, std::vector<Vector3>& corners)
//{
...
//bool ZERO::Math::GetContactPoint(const Ray& ray, const OBB& obb, Vector3& point, Vector3& normal)
//{
//	// Compute the local-to-world/world-to-local matrices
//	Matrix4 matTrans = Matrix4::Translation(obb.center.x, obb.center.y, obb.center.z);
//	Matrix4 matRot = MatrixRotationQuaternion(obb.orientation);
...
Vector3 ZERO::Math::GetClosestPoint(const Ray& ray, const Vector3& point)
{
...
Vector3 ZERO::Math::Mean(const Vector3* v, uint32_t count)
{
...
float ZERO::Math::RandomFloat(float min, float max)
{
	//srand(time(NULL));
...
int ZERO::Math::RandomInt(int min, int max)
{
	//srand(time(NULL));
	ASSERT(max > min, "[Math] Invalid parameters. Max should be greater than Min.");
	return rand() % max + min;
...
Vector3 ZERO::Math::VecMax(const Vector3& a, const Vector3& b)
{
	Vector3 result;
...
Vector3 ZERO::Math::VecMin(const Vector3& a, const Vector3& b)
{
	Vector3 result;
